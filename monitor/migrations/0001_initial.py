# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-10-23 09:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_alive_check_interval', models.IntegerField(default=80, verbose_name='主机存活状态检测间隔')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_sub_service', models.BooleanField(default=False, help_text='如果一个服务有子服务,如一个独立的网卡下面有独立的子网卡')),
        ...
        migrations.AddField(
            model_name='action',
            name='triggers',
            field=models.ManyToManyField(blank=True, help_text='动作绑定在哪个触发器上', to='monitor.Trigger'),
        ),
    ]
