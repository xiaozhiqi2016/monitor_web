...
from monitor_web import settings
from monitor.serializer import  ClientHandler,get_host_triggers,StatusSerializer,TriggersView
from monitor.backends import redis_conn,data_optimization,data_processing
from monitor import models,graphs
import json,time
...
def graphs_gerator(request):
    ...
    # print(type(graphs_data),graphs_data)
    return HttpResponse(graphs_data)
